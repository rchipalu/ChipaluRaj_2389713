...
int main(int argc, char** argv) {
    ...
    cin >> num_qts;//Amount of quarters user has. 
    
    cout << "Enter the number of dimes:\n";
    cin >> num_dim;//Amount of dimes user has. 
    
    cout << "Enter the number of nickels:\n";
    cin >> num_nic;//Amount of nickels user has. 
    
    
    //Process values -> Map inputs to Outputs
    tot_cent = (25 * num_qts) + (10 * num_dim) + (5 * num_nic);//Equation to find total dollar amount in cents.
